...
const StandardFaqPage: React.FC<Props> = ({ data, location }: Props) => {
  ...
  return (
    <Layout location={location}>
      ...
      <BackgroundImage
        Tag="section"
        className="standard-faq-hero-section-bg"
        fluid={hero_background}
        backgroundColor={`#e9f4f8`}
        alt="standard faq hero background"
      >
        <div id="standard-faq-hero-section">
          <Container>
      ...
      <section id="standard-faq">
        <Container>
          <div className="col-lg-12">
            <div className="standard-faq-container">
              <h2 className="text-blue text-center">INF Standard Plan: Frequently Asked Questions</h2>

              <p className="title">Who is eligible for INF Standard Travel Insurance?</p>
              <p>Any Non-US Citizen can apply for the INF Standard Travel Insurance. This includes Green Card holders, H-1B Visa Holders, Permanent Residents, Students on F1 / F1 Visas, and those on OTP. This plan works for all age groups, from age 0 to age 99. The INF Standard Travel Insurance Plan can be used for travel to the United States or Canada.</p>

              <p className="title">When does the travel insurance start and end?</p>
              <p>The Standard Travel Insurance plan will start on the actual start of your trip including any layovers during your travel and will end once you return to your country of permanent residence.</p>
              ...
              <p className="title">What area is covered under the INF Standard Travel Insurance plan?</p>
              <p>The INF Standard Travel Insurance provides coverage during your trip to the United States, Canada and Mexico. Please refer to your policy for additional information.  </p>

              <p className="title">Why should I purchase the INF Standard Travel Insurance Plan?</p>
              <p>The INF Standard Travel Insurance plan is an  insurance for visitors traveling to the United States  The travel insurance is designed to provide coverage for sickness and accident medical expenses, an Accidental Death and Dismemberment Benefit Emergency Medical Evacuation and Repatriation of Remains benefits while you are on your trip.</p>
              ...
              <p className="title">Who underwrites the Standard Travel Insurance Plan? </p>
              ...
              <p className="title">Are the Standard Travel Insurance Plan's Premiums Pro-Rated?</p>
              ...
              <p className="title">How do I apply for the Standard Travel Insurance Plan?</p>
              ...
              <p className="title">Can I renew the Standard Travel Insurance Plan?</p>
              <p>You are able to renew the Standard Travel Insurance Plan for any amount of time after the initial coverage period. We send email, text, and phone call reminders to you 1 week & 1 day before the policy expiration.</p>
              ...
              <p className="treatment">When seeking treatment with a First Health PPO while covered under the INF Standard Travel Insurance plan, please make sure to say the following:<strong> "I have a short-term accident & sickness insurance plan which uses First Health PPO. Do you accept plans which work with First Health PPO?"</strong></p>

              <p><strong>Avoid stating the following:</strong> "I have INF Visitor Accident & Sickness Insurance" or "I have Ace Insurance" or "I have INF Standard Travel Insurance." Providers WILL NOT recognize this language, and your coverage may not be accepted.</p>
              <p className="note"><strong>NOTE: ACE American Insurance Company is not affiliated with, nor are insurance benefits provided, dependent on use of First Health Provider Network.</strong></p>
...
export default StandardFaqPage

export const query = graphql`
  query StandardFaqPageQuery {
    site {
      meta: siteMetadata {
        title
        description
